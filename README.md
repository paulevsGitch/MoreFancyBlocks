	...
	<tbody>
		<tr>
			...
			<td>
				...
				<p>
					Additional blocks and shapes for Minecraft beta
				</p>
				<p>
					Dependencies:
					<ul>
...
Mod adds special crafting stations - saws, that can transform blocks into other blocks or
into other shapes (like stairs or slabs)